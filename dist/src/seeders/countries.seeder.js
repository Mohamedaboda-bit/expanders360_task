...
exports.CountriesSeeder = void 0;
class CountriesSeeder {
    ...
    async run() {
        ...
        for (const country of countries) {
            await this.dataSource.query('INSERT IGNORE INTO countries (country_code, country_name) VALUES (?, ?)', [country.country_code, country.country_name]);
        }
        console.log(`✅ Seeded ${countries.length} countries`);
    }
}
exports.CountriesSeeder = CountriesSeeder;
//# sourceMappingURL=countries.seeder.js.map